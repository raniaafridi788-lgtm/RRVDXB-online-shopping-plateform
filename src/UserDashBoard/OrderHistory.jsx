...
const INITIAL_ORDERS = [
  // --- Page 1 ---
  { id: "#RRVDXB1256", date: "May 16, 2024", product: "Nike Air Max 270", amount: "$160.00", status: "Delivered", statusColor: "bg-emerald-100 text-emerald-600", img: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=100&q=80", trackingCode: "TRK-984210", courier: "FedEx Express" },
  { id: "#RRVDXB1255", date: "May 15, 2024", product: "Apple Watch Series 9", amount: "$399.00", status: "Shipping", statusColor: "bg-blue-100 text-blue-600", img: "https://images.unsplash.com/photo-1579586337278-3befd40fd17a?w=100&q=80", trackingCode: "TRK-983102", courier: "DHL Priority" },
  { id: "#RRVDXB1254", date: "May 14, 2024", product: "Michael Kors Bag", amount: "$350.00", status: "Delivered", statusColor: "bg-emerald-100 text-emerald-600", img: "https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=100&q=80", trackingCode: "TRK-981044", courier: "UPS Ground" },
  { id: "#RRVDXB1253", date: "May 12, 2024", product: "Ray-Ban Sunglasses", amount: "$155.00", status: "Processing", statusColor: "bg-amber-100 text-amber-600", img: "https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=100&q=80", trackingCode: "TRK-979822", courier: "USPS Priority" },
  // --- Page 2 ---
  { id: "#RRVDXB1252", date: "May 10, 2024", product: "Dior Sauvage Parfum", amount: "$120.00", status: "Cancelled", statusColor: "bg-rose-100 text-rose-500", img: "https://images.unsplash.com/photo-1541643600914-78b084683601?w=100&q=80", trackingCode: "N/A", courier: "N/A" },
  { id: "#RRVDXB1251", date: "May 08, 2024", product: "Sony WH-1000XM5", amount: "$349.00", status: "Returned", statusColor: "bg-purple-100 text-purple-600", img: "https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=100&q=80", trackingCode: "TRK-975510", courier: "FedEx Express" },
  { id: "#RRVDXB1250", date: "May 07, 2024", product: "Mechanical Keyboard", amount: "$130.00", status: "Delivered", statusColor: "bg-emerald-100 text-emerald-600", img: "https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=100&q=80", trackingCode: "TRK-972100", courier: "UPS Ground" },
  { id: "#RRVDXB1249", date: "May 05, 2024", product: "Jumbo Yoga Mat", amount: "$45.00", status: "Delivered", statusColor: "bg-emerald-100 text-emerald-600", img: "https://images.unsplash.com/photo-1601925260368-ae2f83cf8b7f?w=100&q=80", trackingCode: "TRK-970112", courier: "USPS Priority" },
  // --- Page 3 ---
  { id: "#RRVDXB1248", date: "Apr 29, 2024", product: "Instant Pot Duo", amount: "$89.00", status: "Shipping", statusColor: "bg-blue-100 text-blue-600", img: "https://images.unsplash.com/photo-1556911220-e15b29be8c8f?w=100&q=80", trackingCode: "TRK-968501", courier: "FedEx Express" },
  { id: "#RRVDXB1247", date: "Apr 25, 2024", product: "Hydro Flask Bottle", amount: "$40.00", status: "Delivered", statusColor: "bg-emerald-100 text-emerald-600", img: "https://images.unsplash.com/photo-1602143407151-7111542de6e8?w=100&q=80", trackingCode: "TRK-965412", courier: "USPS Priority" },
  // --- Page 4 ---
  { id: "#RRVDXB1246", date: "Apr 20, 2024", product: "Kindle Paperwhite", amount: "$149.00", status: "Delivered", statusColor: "bg-emerald-100 text-emerald-600", img: "https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=100&q=80", trackingCode: "TRK-961023", courier: "DHL Priority" },
  // --- Page 5 ---
  { id: "#RRVDXB1245", date: "Apr 15, 2024", product: "Anker Power Bank", amount: "$60.00", status: "Delivered", statusColor: "bg-emerald-100 text-emerald-600", img: "https://images.unsplash.com/photo-1609592424097-d5d36e2f1837?w=100&q=80", trackingCode: "TRK-959821", courier: "UPS Ground" }
];
